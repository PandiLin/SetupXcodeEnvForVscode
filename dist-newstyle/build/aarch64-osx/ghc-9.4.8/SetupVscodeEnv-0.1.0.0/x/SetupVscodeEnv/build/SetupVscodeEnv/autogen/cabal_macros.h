...
/* package SetupVscodeEnv-0.1.0.0 */
#ifndef VERSION_SetupVscodeEnv
#define VERSION_SetupVscodeEnv "0.1.0.0"
#endif /* VERSION_SetupVscodeEnv */
#ifndef MIN_VERSION_SetupVscodeEnv
#define MIN_VERSION_SetupVscodeEnv(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_SetupVscodeEnv */
...
/* package reactive-banana-1.3.2.0 */
#ifndef VERSION_reactive_banana
#define VERSION_reactive_banana "1.3.2.0"
...
#define CURRENT_COMPONENT_ID "SetupVscodeEnv-0.1.0.0-inplace-SetupVscodeEnv"
